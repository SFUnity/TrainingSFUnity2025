...
public class Intake extends SubsystemBase {
  // private final IntakeVisualizer measuredVisualizer = new IntakeVisualizer("Measured",
  // Color.kRed);
  // private final IntakeVisualizer setpointVisualizer = new IntakeVisualizer("Setpoint",
  // Color.kBlue);
